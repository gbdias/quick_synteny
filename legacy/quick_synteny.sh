...
singularity exec -B $BASE:$BASE ${GFFREAD} gffread -x ${TARGETNAME}_cds.fa -g ${TARGET} ${TARGETNAME}.gff
singularity exec -B $BASE:$BASE ${GFFREAD} gffread -x ${REFNAME}_cds.fa -g ${REF} ${REFNAME}.gff
